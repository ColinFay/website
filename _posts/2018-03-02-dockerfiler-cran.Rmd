...
{dockerfiler}, a package for easy Dockerfile creation from R is now on CRAN.  

 <!--more-->
 
 {dockerfiler} is a package that comes with a simple, object orienteted, API for Dockerfile creation, straight from your R session. 
