...
Accédez à l'API du réseau social Pinterest directement dans R avec ```{r} 
rpinterest
```, package désormais disponible sur le <a href="https://cran.r-project.org/web/packages/rpinterest/index.html" target="_blank">CRAN</a>.
